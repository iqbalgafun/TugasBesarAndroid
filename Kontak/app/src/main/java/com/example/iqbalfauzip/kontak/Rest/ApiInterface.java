...
public interface ApiInterface {
    ...
    @FormUrlEncoded
    @POST("pendaftar")
    Call<PostPutDelPendaftar> postPendaftar(@Field("id_pen") String id_pen,
                                            @Field("nama") String nama,
                                            @Field("alamat") String alamat,
                                            @Field("ttl") String ttl);
    @FormUrlEncoded
    @PUT("pendaftar")
    Call<PostPutDelPendaftar> putPendaftar(@Field("id_pen") String id_pen,
                                     @Field("nama") String nama,
                                     @Field("alamat") String alamat,
                                     @Field("ttl") String ttl);
    @FormUrlEncoded
    @HTTP(method = "DELETE", path = "pendaftar", hasBody = true)
    Call<PostPutDelPendaftar> deletePendaftar(@Field("id_pen") String id_pen);
