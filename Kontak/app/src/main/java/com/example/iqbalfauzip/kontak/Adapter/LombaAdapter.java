...
public class LombaAdapter extends RecyclerView.Adapter<LombaAdapter.MyViewHolder>{
    ...
    public void onBindViewHolder (LombaAdapter.MyViewHolder holder, final int position){
        ...
        holder.mTextViewPid.setText("Pid = " + mLombaList.get(position).getPid());
        holder.mTextViewId_pen.setText("Id_Pendaftar = " + mLombaList.get(position).getId_pen());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mIntent.putExtra("Pid", mLombaList.get(position).getPid());
                mIntent.putExtra("Id_pen", mLombaList.get(position).getId_pen());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView mTextViewId, mTextViewPid, mTextViewId_pen, mTextViewNama, mTextViewCabang, mTextViewTgl;

        public MyViewHolder(View itemView) {
            super(itemView);
            mTextViewId = (TextView) itemView.findViewById(R.id.tvId);
            mTextViewPid = (TextView) itemView.findViewById(R.id.tvPid);
            mTextViewId_pen = (TextView) itemView.findViewById(R.id.tvId_pen);
